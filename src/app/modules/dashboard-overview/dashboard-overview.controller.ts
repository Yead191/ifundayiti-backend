...
const getImpactStats = catchAsync(async (req: Request, res: Response) => {
  const result = await DashboardOverviewServices.getImpactStatsFromDB();
  sendResponse(res, {
    success: true,
    statusCode: StatusCodes.OK,
    message: 'Impact stats fetched successfully',
    data: result,
  });
});
