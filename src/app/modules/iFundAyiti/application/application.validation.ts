...
const updateWinnerInformationZodSchema = z.object({
  body: z.object({
    successStory: z.string().trim().optional(),
    quote: z.string().trim().optional(),
    awardedAmount: z.number().min(50).max(1000).optional(),
  }),
});
...
export const applicationValidation = {
  ...
  updateWinnerInformationZodSchema,
};
